#ifndef COMPSCI642_LOG_INCLUDED
#define COMPSCI642_LOG_INCLUDED

////////////////////////////////////////////////////////////////////////////////
//
//  File          : compsci642_log.h
//  Description   : This is the logging service for the COMPSCI642 utility
...
#define LOG_SERVICE_NAME "compsci642.log"
...
#define COMPSCI642_LOG_STDOUT 1
#define COMPSCI642_LOG_STDERR 2
...
#define COMPSCI642_ASSERT0(expr,x) logAssert(expr, __FILE__, __LINE__, x);
#define COMPSCI642_ASSERT1(expr,x,y) logAssert(expr, __FILE__, __LINE__, x, y);
#define COMPSCI642_ASSERT2(expr,x,y,z) logAssert(expr, __FILE__, __LINE__, x, y, z);
